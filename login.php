...
<body>
    ...
    <form method="POST" action="" autocomplete="off">
        ...
        <input type="email" name="email" id="email" required autocomplete="off" spellcheck="false">
        
        <label for="Password">Password:</label>
        <input type="password" name="Password" id="Password" required autocomplete="new-password" spellcheck="false">
